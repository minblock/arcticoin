...
pkgdatadir = $(datadir)/arcticoin
pkgincludedir = $(includedir)/arcticoin
pkglibdir = $(libdir)/arcticoin
pkglibexecdir = $(libexecdir)/arcticoin
...
ACLOCAL = ${SHELL} /arcticoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /arcticoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /arcticoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /arcticoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = arcticoin-cli
BITCOIN_DAEMON_NAME = arcticoind
BITCOIN_GUI_NAME = arcticoin-qt
BITCOIN_TX_NAME = arcticoin-tx
BITCOIN_WALLET_TOOL_NAME = arcticoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The arcticoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = arcticoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /arcticoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = arcticoin
PACKAGE_BUGREPORT = https://github.com/arcticoin-project/arcticoin/issues
PACKAGE_NAME = arcticoin Core
PACKAGE_STRING = arcticoin Core 0.18.1
PACKAGE_TARNAME = arcticoin
PACKAGE_URL = https://arcticoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /arcticoin
abs_srcdir = /arcticoin
abs_top_builddir = /arcticoin
abs_top_srcdir = /arcticoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /arcticoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/arcticoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/arcticoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/arcticoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/arcticoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
