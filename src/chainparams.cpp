...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting botoshies!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586337109, 40938, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1b015e2b0ed1c4eea100e5521045b222102b102d05e1b9e7d568432e81022488"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd2fa14621d8a1dd24a86b9d8b89fe9aa74fc849ed1f5670dfe72712bc4b673a"));
        ...
        vSeeds.emplace_back("seed-a.arcticoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.arcticointools.com");
        vSeeds.emplace_back("dnsseed.arcticoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 61941, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xade1d292517ab67bdf14d968818ea6d7255245785c51fda0839d7db0b239e837"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd2fa14621d8a1dd24a86b9d8b89fe9aa74fc849ed1f5670dfe72712bc4b673a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.arcticointools.com");
        vSeeds.emplace_back("seed-b.arcticoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa7458180abaafa1ea9c8d5fa423dff4264d052eac0effbd89c6d74c364fe0dae"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd2fa14621d8a1dd24a86b9d8b89fe9aa74fc849ed1f5670dfe72712bc4b673a"));
