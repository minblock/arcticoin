...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " arcticoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  arcticoin-tx [options] <hex-tx> [commands]  Update hex-encoded arcticoin transaction\n" +
            "or:     arcticoin-tx [options] -create [commands]   Create hex-encoded arcticoin transaction\n" +
            "\n";
