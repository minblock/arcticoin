# Support for Output Descriptors in arcticoin Core

Since arcticoin Core v0.17, there is support for Output Descriptors. This is a
...
on arcticoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing arcticoin Core wallets, a convenience function `combo` is
