...
"""Verify that starting arcticoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arcticoin with -h for help text")
        ...
        self.log.info("Start arcticoin with -version for version information")
        ...
        self.log.info("Start arcticoind with -fakearg to make sure it does not start")
